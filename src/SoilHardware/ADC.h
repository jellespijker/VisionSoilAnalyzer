...
#define ADC0_PATH                                                              \
  "/sys/bus/iio/devices/iio:device0/in_voltage0_raw" /*!< path to analogue pin \
                                                        0*/
#define ADC1_PATH                                                              \
  "/sys/bus/iio/devices/iio:device0/in_voltage1_raw" /*!< path to analogue pin \
                                                        1*/
#define ADC2_PATH                                                              \
  "/sys/bus/iio/devices/iio:device0/in_voltage2_raw" /*!< path to analogue pin \
                                                        2*/
#define ADC3_PATH                                                              \
  "/sys/bus/iio/devices/iio:device0/in_voltage3_raw" /*!< path to analogue pin \
                                                        3*/
#define ADC4_PATH                                                              \
  "/sys/bus/iio/devices/iio:device0/in_voltage4_raw" /*!< path to analogue pin \
                                                        4*/
#define ADC5_PATH                                                              \
  "/sys/bus/iio/devices/iio:device0/in_voltage5_raw" /*!< path to analogue pin \
                                                        5*/
#define ADC6_PATH                                                              \
  "/sys/bus/iio/devices/iio:device0/in_voltage6_raw" /*!< path to analogue pin \
                                                        6*/
#define ADC7_PATH                                                              \
  "/sys/bus/iio/devices/iio:device0/in_voltage7_raw" /*!< path to analogue pin \
                                                        7*/

namespace Hardware {
class ADC : public BBB {
public:
