...
#define SLOTS "/sys/devices/bone_capemgr.9/slots" /*!< Beaglebone capemanager slots file*/
...
namespace Hardware
{
	typedef int(*CallbackType)(int); /*!< CallbackType used to pass a function to a thread*/
