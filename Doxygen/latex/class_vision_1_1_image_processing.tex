...
\subsubsection[{Progress\+\_\+t}]{\setlength{\rightskip}{0pt plus 5cm}typedef boost\+::signals2\+::signal$<$void(float, std\+::string)$>$ {\bf Vision\+::\+Image\+Processing\+::\+Progress\+\_\+t}}\label{class_vision_1_1_image_processing_ade0de8f6751f8d19b8fbb9533a009d3c}
...
Definition at line 17 of file Image\+Processing.\+cpp.
...
Definition at line 20 of file Image\+Processing.\+cpp.
...
Definition at line 49 of file Image\+Processing.\+cpp.
...
\begin{DoxyCode}
49                                                                        \{
50   \textcolor{keywordflow}{return} \hyperlink{class_vision_1_1_image_processing_ac0c168e16365ff5941791f67ec895663}{prog\_sig}.connect(subscriber);
51 \}
\end{DoxyCode}
...
Definition at line 77 of file Image\+Processing.\+h.
...
79     uint32\_t nData = src.rows * src.cols * dst.step[1];
80     \textcolor{keywordflow}{if} (cvType == 0 || cvType == 8 || cvType == 16 || cvType == 24) \{
81       \textcolor{keywordflow}{for} (uint32\_t \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} = 0; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} < nData; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} += dst.step[1]) \{
82         dst.data[\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}] =
83             \textcolor{keyword}{static\_cast<}uint8\_t\textcolor{keyword}{>}(LUT[*(T2 *)(src.data + (\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} * src.step[1]))]);
84       \}
85     \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (cvType == 1 || cvType == 9 || cvType == 17 || cvType == 25) \{
86       \textcolor{keywordflow}{for} (uint32\_t \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} = 0; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} < nData; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} += src.step[1]) \{
87         dst.data[\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}] =
88             \textcolor{keyword}{static\_cast<}int8\_t\textcolor{keyword}{>}(LUT[*(T2 *)(src.data + (\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} * src.step[1]))]);
89       \}
90     \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (cvType == 2 || cvType == 10 || cvType == 18 || cvType == 26) \{
91       \textcolor{keywordflow}{for} (uint32\_t \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} = 0; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} < nData; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} += src.step[1]) \{
92         dst.data[\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}] =
93             \textcolor{keyword}{static\_cast<}uint16\_t\textcolor{keyword}{>}(LUT[*(T2 *)(src.data + (\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} * src.step[1]))]);
94       \}
...
Definition at line 116 of file Image\+Processing.\+h.
...
129 
130     \textcolor{keywordtype}{int} cvBaseType = cvType % 8;
...
Definition at line 42 of file Image\+Processing.\+cpp.
...
43   vector<Mat> chans;
44   split(src, chans);
45   \textcolor{keywordflow}{return} chans;
46 \}
\end{DoxyCode}
...
Definition at line 30 of file Image\+Processing.\+cpp.
...
\begin{DoxyCode}
31                                                     \{
32   \textcolor{comment}{// Create LUT to determine when there is an new row}
33   \hyperlink{_soil_math_types_8h_a65f85814a8290f9797005d3b28e7e5fc}{uchar} *nRow = \textcolor{keyword}{new} \hyperlink{_soil_math_types_8h_a65f85814a8290f9797005d3b28e7e5fc}{uchar}[nData + 1]\{\};
34   \textcolor{comment}{// int i = 0;}
35   \textcolor{keywordtype}{int} shift = nCols - hKsize - 1;
36   \textcolor{keywordflow}{for} (uint32\_t \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} = 0; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} < totalRows; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}++) \{
37     nRow[(\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} * nCols) + shift] = 1;
38   \}
39   \textcolor{keywordflow}{return} nRow;
40 \}
\end{DoxyCode}
...
Definition at line 145 of file Image\+Processing.\+h.
...
152         \textcolor{keywordtype}{int} cvBaseType = img.type() % 8;
