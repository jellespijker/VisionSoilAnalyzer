...
\begin{DoxyCode}
24191     : \hyperlink{class_q_c_p_abstract_item_a9922507d8b4503a1fe1ed0b1030e23b6}{QCPAbstractItem}(parentPlot),
24192       \hyperlink{class_q_c_p_item_line_a602da607a09498b0f152ada1d6851bc5}{start}(\hyperlink{class_q_c_p_abstract_item_a75036d39c4d4e2e1a7dd145fff915d32}{createPosition}(QLatin1String(\textcolor{stringliteral}{"start"}))),
24193       \hyperlink{class_q_c_p_item_line_a15598864c1c22a2497a1979c4980c4e1}{end}(\hyperlink{class_q_c_p_abstract_item_a75036d39c4d4e2e1a7dd145fff915d32}{createPosition}(QLatin1String(\textcolor{stringliteral}{"end"}))) \{
24194   \hyperlink{class_q_c_p_item_line_a602da607a09498b0f152ada1d6851bc5}{start}->\hyperlink{class_q_c_p_item_position_aa988ba4e87ab684c9021017dcaba945f}{setCoords}(0, 0);
24195   \hyperlink{class_q_c_p_item_line_a15598864c1c22a2497a1979c4980c4e1}{end}->\hyperlink{class_q_c_p_item_position_aa988ba4e87ab684c9021017dcaba945f}{setCoords}(1, 1);
24196 
24197   \hyperlink{class_q_c_p_item_line_a572528dab61c1abe205822fbd5db4b27}{setPen}(QPen(Qt::black));
24198   \hyperlink{class_q_c_p_item_line_a3e2fec44503277e77717e9c24f87f1ea}{setSelectedPen}(QPen(Qt::blue, 2));
24199 \}
\end{DoxyCode}
...
Definition at line 24201 of file qcustomplot.\+cpp.
...
Definition at line 24254 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
24254                                           \{
24255   QVector2D startVec(\hyperlink{class_q_c_p_item_line_a602da607a09498b0f152ada1d6851bc5}{start}->\hyperlink{class_q_c_p_item_position_ae490f9c76ee2ba33752c495d3b6e8fb5}{pixelPoint}());
24256   QVector2D endVec(\hyperlink{class_q_c_p_item_line_a15598864c1c22a2497a1979c4980c4e1}{end}->\hyperlink{class_q_c_p_item_position_ae490f9c76ee2ba33752c495d3b6e8fb5}{pixelPoint}());
24257   \textcolor{keywordflow}{if} (startVec.toPoint() == endVec.toPoint())
24258     \textcolor{keywordflow}{return};
24259   \textcolor{comment}{// get visible segment of straight line inside clipRect:}
24260   \textcolor{keywordtype}{double} clipPad = qMax(\hyperlink{class_q_c_p_item_line_a51603f28ab7ddb1c1a95ea384791d3ed}{mHead}.\hyperlink{class_q_c_p_line_ending_a586b45cf738881a70119e353dc1ed59c}{boundingDistance}(), \hyperlink{class_q_c_p_item_line_ab8ed61dfe15bbb1cbf9b95eae95e242f}{mTail}.
      \hyperlink{class_q_c_p_line_ending_a586b45cf738881a70119e353dc1ed59c}{boundingDistance}());
24261   clipPad = qMax(clipPad, (\textcolor{keywordtype}{double})\hyperlink{class_q_c_p_item_line_a7b5bc4ebacb55774b87c91b308ca7912}{mainPen}().widthF());
24262   QLineF line = \hyperlink{class_q_c_p_item_line_a36e8620019a221ccea4357f0287b81c2}{getRectClippedLine}(
24263       startVec, endVec,
24264       \hyperlink{class_q_c_p_abstract_item_a538e25ff8856534582f5b2b400a46405}{clipRect}().adjusted(-clipPad, -clipPad, clipPad, clipPad));
24265   \textcolor{comment}{// paint visible segment, if existent:}
24266   \textcolor{keywordflow}{if} (!line.isNull()) \{
24267     painter->\hyperlink{class_q_c_p_painter_af9c7a4cd1791403901f8c5b82a150195}{setPen}(\hyperlink{class_q_c_p_item_line_a7b5bc4ebacb55774b87c91b308ca7912}{mainPen}());
24268     painter->\hyperlink{class_q_c_p_painter_a0b4b1b9bd495e182c731774dc800e6e0}{drawLine}(line);
24269     painter->setBrush(Qt::SolidPattern);
24270     \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_item_line_ab8ed61dfe15bbb1cbf9b95eae95e242f}{mTail}.\hyperlink{class_q_c_p_line_ending_aea324dbfddbca9895ca8a3a968671299}{style}() != \hyperlink{class_q_c_p_line_ending_a5ef16e6876b4b74959c7261d8d4c2cd5aca12d500f50cd6871766801bac30fb03}{QCPLineEnding::esNone})
24271       \hyperlink{class_q_c_p_item_line_ab8ed61dfe15bbb1cbf9b95eae95e242f}{mTail}.\hyperlink{class_q_c_p_line_ending_ac4b2fa94bd27b2f008b5fc090fcd7c0b}{draw}(painter, startVec, startVec - endVec);
24272     \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_item_line_a51603f28ab7ddb1c1a95ea384791d3ed}{mHead}.\hyperlink{class_q_c_p_line_ending_aea324dbfddbca9895ca8a3a968671299}{style}() != \hyperlink{class_q_c_p_line_ending_a5ef16e6876b4b74959c7261d8d4c2cd5aca12d500f50cd6871766801bac30fb03}{QCPLineEnding::esNone})
24273       \hyperlink{class_q_c_p_item_line_a51603f28ab7ddb1c1a95ea384791d3ed}{mHead}.\hyperlink{class_q_c_p_line_ending_ac4b2fa94bd27b2f008b5fc090fcd7c0b}{draw}(painter, endVec, endVec - startVec);
24274   \}
24275 \}
\end{DoxyCode}
...
Definition at line 24285 of file qcustomplot.\+cpp.
...
24358       \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} k = \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} + 1; k < pointVectors.size(); ++k) \{
24359         \textcolor{keywordtype}{double} distSqr =
24360             (pointVectors.at(\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}) - pointVectors.at(k)).lengthSquared();
24361         \textcolor{keywordflow}{if} (distSqr > distSqrMax) \{
24362           pv1 = pointVectors.at(\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i});
24363           pv2 = pointVectors.at(k);
24364           distSqrMax = distSqr;
24365         \}
24366       \}
24367     \}
24368     result.setPoints(pv1.toPointF(), pv2.toPointF());
24369   \}
24370   \textcolor{keywordflow}{return} result;
24371 \}
\end{DoxyCode}
...
Definition at line 3752 of file qcustomplot.\+h.
...
\begin{DoxyCode}
3752 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_item_line_a51603f28ab7ddb1c1a95ea384791d3ed}{mHead}; \}
\end{DoxyCode}
...
Definition at line 24378 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
24378 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_abstract_item_a4bdb3457dad1d268c0f78a44152b9645}{mSelected} ? \hyperlink{class_q_c_p_item_line_aff858ad6dde3b90024814ca4b116f278}{mSelectedPen} : \hyperlink{class_q_c_p_item_line_abbb544d5bb927dfe4e81a7f3ca4c65ac}{mPen}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
3750 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_item_line_abbb544d5bb927dfe4e81a7f3ca4c65ac}{mPen}; \}
\end{DoxyCode}
...
Definition at line 3751 of file qcustomplot.\+h.


\begin{DoxyCode}
3751 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_item_line_aff858ad6dde3b90024814ca4b116f278}{mSelectedPen}; \}
\end{DoxyCode}
...
Definition at line 24244 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
24245                                                         \{
24246   Q\_UNUSED(details)
24247   if (onlySelectable && !\hyperlink{class_q_c_p_abstract_item_ad81eb35c8726a0f458db9df9732e0e41}{mSelectable})
24248     return -1;
24249 
24250   return qSqrt(\hyperlink{class_q_c_p_abstract_item_acdca343717d625b8abb3c3e38c0ed39d}{distSqrToLine}(\hyperlink{class_q_c_p_item_line_a602da607a09498b0f152ada1d6851bc5}{start}->pixelPoint(), \hyperlink{class_q_c_p_item_line_a15598864c1c22a2497a1979c4980c4e1}{end}->pixelPoint(), pos));
24251 \}
\end{DoxyCode}
...
Definition at line 24228 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
24228 \{ \hyperlink{class_q_c_p_item_line_a51603f28ab7ddb1c1a95ea384791d3ed}{mHead} = \hyperlink{class_q_c_p_item_line_a5f6cbc5c763feae9dfbce71748fc43f1}{head}; \}
\end{DoxyCode}
...
Definition at line 24215 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
24215 \{ \hyperlink{class_q_c_p_item_line_aff858ad6dde3b90024814ca4b116f278}{mSelectedPen} = \hyperlink{class_q_c_p_item_line_a235779dd079a263bedb20b3daecc40eb}{pen}; \}
\end{DoxyCode}
...
Definition at line 24241 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
24241 \{ \hyperlink{class_q_c_p_item_line_ab8ed61dfe15bbb1cbf9b95eae95e242f}{mTail} = \hyperlink{class_q_c_p_item_line_a5d2ca0f784933e80f3e6e1d15dceebb3}{tail}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
3753 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_item_line_ab8ed61dfe15bbb1cbf9b95eae95e242f}{mTail}; \}
\end{DoxyCode}
