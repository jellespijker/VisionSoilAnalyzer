...
\hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0ca261f8ea78cf3c9561726223ffa33dc12}{ae\+Zero\+Line}, 
...
\begin{DoxyCode}
126                         \{
127   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0caefa92e89cd37f8a081fd2075aa1af73f}{aeAxes} = 0x0001 
128   ,
129   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0ca4fbb37118d62288af0ca601ff2b07a2f}{aeGrid} = 0x0002 
130   ,
131   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0caaedf83369188a15a69f92bb1d85ca97b}{aeSubGrid} = 0x0004 
132   ,
133   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0ca9e0127a6361b5d0596b031a482c5cf97}{aeLegend} = 0x0008 
134   ,
135   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0ca1aca7a50c1b95403958733a4acafe773}{aeLegendItems} = 0x0010 
136   ,
137   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0ca4145e4251b0cf2dbedabeea0a38f84f6}{aePlottables} = 0x0020 
138   ,
140   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0caf7712a85d6b0c75b24301d2fe9484db3}{aeItems} = 0x0040 
141   ,
142   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0cae45ed8cd167bffe27d7f40da4bc17e9c}{aeScatters} = 0x0080 
143   ,
145   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0ca9dcf3882cb321bb305f71fdc0f09f63d}{aeErrorBars} = 0x0100 
146   ,
147   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0ca788810f0aa930137de6ad6cc6d83d354}{aeFills} = 0x0200 
148   ,
150   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0ca261f8ea78cf3c9561726223ffa33dc12}{aeZeroLine} =
151       0x0400 
152   ,
153   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0caa897c232a0ffc8368e7c100ffc59ef31}{aeAll} = 0xFFFF 
154   ,
155   \hyperlink{namespace_q_c_p_ae55dbe315d41fe80f29ba88100843a0caa9e90d81896358757d94275aeaa58f6a}{aeNone} = 0x0000 
156 \};
\end{DoxyCode}
...
Definition at line 98 of file qcustomplot.\+h.
...
Definition at line 165 of file qcustomplot.\+h.


\begin{DoxyCode}
165                   \{
166   \hyperlink{namespace_q_c_p_a5400e5fcb9528d92002ddb938c1f4ef4ab7283c5bfc1ba9e597015389880bda42}{phNone} = 0x000 
167   ,
168   \hyperlink{namespace_q_c_p_a5400e5fcb9528d92002ddb938c1f4ef4aa5fd227bc878c56ad2a87ea32c74ee4d}{phFastPolylines} = 0x001 
169   ,
173   \hyperlink{namespace_q_c_p_a5400e5fcb9528d92002ddb938c1f4ef4aa3090dafa0e0f9a28c579c79d6c2d283}{phForceRepaint} = 0x002 
174   ,
180   \hyperlink{namespace_q_c_p_a5400e5fcb9528d92002ddb938c1f4ef4a8e9cfe5ee0c5cd36dd7accf9739aff65}{phCacheLabels} = 0x004 
181 \};
\end{DoxyCode}
...
References ms\+Bottom, ms\+Left, ms\+Right, and ms\+Top.



Referenced by Q\+C\+P\+Layout\+Element\+::calculate\+Auto\+Margin(), Q\+C\+P\+Margin\+Group\+::common\+Margin(), and Q\+C\+P\+Layout\+Element\+::update().


\begin{DoxyCode}
280                                                                        \{
281   \textcolor{keywordflow}{switch} (side) \{
282   \textcolor{keywordflow}{case} \hyperlink{namespace_q_c_p_a7e487e3e2ccb62ab7771065bab7cae54a9500c8bfcc9e80b9dff0a8e00e867f07}{QCP::msLeft}:
283     \textcolor{keywordflow}{return} margins.left();
284   \textcolor{keywordflow}{case} \hyperlink{namespace_q_c_p_a7e487e3e2ccb62ab7771065bab7cae54a93c719593bb2b94ed244d52c86d83b65}{QCP::msRight}:
285     \textcolor{keywordflow}{return} margins.right();
286   \textcolor{keywordflow}{case} \hyperlink{namespace_q_c_p_a7e487e3e2ccb62ab7771065bab7cae54a5db8fb0d0b0ecf0d611c2602a348e8a0}{QCP::msTop}:
287     \textcolor{keywordflow}{return} margins.top();
288   \textcolor{keywordflow}{case} \hyperlink{namespace_q_c_p_a7e487e3e2ccb62ab7771065bab7cae54a5241d8eac2bab9524a38889f576179cc}{QCP::msBottom}:
289     \textcolor{keywordflow}{return} margins.bottom();
...
Referenced by Q\+C\+P\+Graph\+::draw(), Q\+C\+P\+Curve\+::draw(), Q\+C\+P\+Bars\+::draw(), Q\+C\+P\+Statistical\+Box\+::draw(), and is\+Invalid\+Data().


\begin{DoxyCode}
231                                         \{
232   \textcolor{keywordflow}{return} qIsNaN(value) || qIsInf(value);
233 \}
\end{DoxyCode}
...
\begin{center}
\leavevmode
\includegraphics[width=343pt]{namespace_q_c_p_a07ab701c05329089f933b9cae2638a63_icgraph}
\end{center}
\end{figure}
...
References is\+Invalid\+Data().


\begin{DoxyCode}
240                                                         \{
241   \textcolor{keywordflow}{return} \hyperlink{namespace_q_c_p_a728903e5c3dd17847bee280f4005496f}{isInvalidData}(value1) || \hyperlink{namespace_q_c_p_a728903e5c3dd17847bee280f4005496f}{isInvalidData}(value2);
242 \}
\end{DoxyCode}
...
Definition at line 250 of file qcustomplot.\+h.



References ms\+All, ms\+Bottom, ms\+Left, ms\+Right, and ms\+Top.



Referenced by Q\+C\+P\+Layout\+Element\+::update().
