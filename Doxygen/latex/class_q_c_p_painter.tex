...
Definition at line 421 of file qcustomplot.\+h.


\begin{DoxyCode}
421                    \{
422     \hyperlink{class_q_c_p_painter_a156cf16444ff5e0d81a73c615fdb156da3bac5e87e3d58553b297befb4eee2a45}{pmDefault} =
423         0x00 
424     ,
425     \hyperlink{class_q_c_p_painter_a156cf16444ff5e0d81a73c615fdb156daeda679cd55dcd468341d07d48a30b6ab}{pmVectorized} = 0x01 
426     ,
429     \hyperlink{class_q_c_p_painter_a156cf16444ff5e0d81a73c615fdb156dae78f9a4eb277a5f9207f50850a51a0b0}{pmNoCaching} = 0x02 
430     ,
433     \hyperlink{class_q_c_p_painter_a156cf16444ff5e0d81a73c615fdb156dac1e481bfaf408f2bd2eaad3ec341f36b}{pmNonCosmetic} = 0x04 
434   \};
\end{DoxyCode}
...
Definition at line 54 of file qcustomplot.\+cpp.


\begin{DoxyCode}
55     : QPainter(), \hyperlink{class_q_c_p_painter_af5d1d6e5df0adbc7de5633250fb3396c}{mModes}(\hyperlink{class_q_c_p_painter_a156cf16444ff5e0d81a73c615fdb156da3bac5e87e3d58553b297befb4eee2a45}{pmDefault}), \hyperlink{class_q_c_p_painter_a7055085da176aee0f6b23298f1003d08}{mIsAntialiasing}(\textcolor{keyword}{false}) \{
56   \textcolor{comment}{// don't setRenderHint(QPainter::NonCosmeticDefautPen) here, because painter}
57   \textcolor{comment}{// isn't active yet and}
58   \textcolor{comment}{// a call to begin() will follow}
59 \}
\end{DoxyCode}
...
\begin{DoxyCode}
71     : QPainter(device), \hyperlink{class_q_c_p_painter_af5d1d6e5df0adbc7de5633250fb3396c}{mModes}(\hyperlink{class_q_c_p_painter_a156cf16444ff5e0d81a73c615fdb156da3bac5e87e3d58553b297befb4eee2a45}{pmDefault}), \hyperlink{class_q_c_p_painter_a7055085da176aee0f6b23298f1003d08}{mIsAntialiasing}(\textcolor{keyword}{false}) \{
72 \textcolor{preprocessor}{#if QT\_VERSION <                                                               \(\backslash\)}
73 \textcolor{preprocessor}{    QT\_VERSION\_CHECK(5, 0, 0) // before Qt5, default pens used to be cosmetic if}
74                               \textcolor{comment}{// NonCosmeticDefaultPen flag isn't set. So we set}
75                               \textcolor{comment}{// it to get consistency across Qt versions.}
76   \textcolor{keywordflow}{if} (isActive())
...
Definition at line 81 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
446 \{ \textcolor{keywordflow}{return} testRenderHint(QPainter::Antialiasing); \}
\end{DoxyCode}
...
Definition at line 187 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
187                                            \{
188   \textcolor{keywordtype}{bool} result = QPainter::begin(device);
189 \textcolor{preprocessor}{#if QT\_VERSION <                                                               \(\backslash\)}
190 \textcolor{preprocessor}{    QT\_VERSION\_CHECK(5, 0, 0) // before Qt5, default pens used to be cosmetic if}
191                               \textcolor{comment}{// NonCosmeticDefaultPen flag isn't set. So we set}
192                               \textcolor{comment}{// it to get consistency across Qt versions.}
193   \textcolor{keywordflow}{if} (result)
194     setRenderHint(QPainter::NonCosmeticDefaultPen);
195 \textcolor{preprocessor}{#endif}
196   \textcolor{keywordflow}{return} result;
197 \}
\end{DoxyCode}
...
\begin{DoxyCode}
460                                                       \{
461     \hyperlink{class_q_c_p_painter_a0b4b1b9bd495e182c731774dc800e6e0}{drawLine}(QLineF(p1, p2));
462   \}
\end{DoxyCode}
...
Definition at line 250 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
250                                  \{
251   \textcolor{keywordflow}{if} (qFuzzyIsNull(pen().widthF())) \{
252     QPen p = pen();
253     p.setWidth(1);
254     QPainter::setPen(p);
255   \}
256 \}
\end{DoxyCode}
...
\begin{DoxyCode}
447 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_painter_af5d1d6e5df0adbc7de5633250fb3396c}{mModes}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
222                       \{
223   \hyperlink{class_q_c_p_painter_a0189e641bbf7dc31ac15aef7b36501fa}{mAntialiasingStack}.push(\hyperlink{class_q_c_p_painter_a7055085da176aee0f6b23298f1003d08}{mIsAntialiasing});
224   QPainter::save();
225 \}
\end{DoxyCode}
...
Definition at line 150 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
150                                              \{
151   setRenderHint(QPainter::Antialiasing, enabled);
152   \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_painter_a7055085da176aee0f6b23298f1003d08}{mIsAntialiasing} != enabled) \{
153     \hyperlink{class_q_c_p_painter_a7055085da176aee0f6b23298f1003d08}{mIsAntialiasing} = enabled;
154     \textcolor{keywordflow}{if} (!\hyperlink{class_q_c_p_painter_af5d1d6e5df0adbc7de5633250fb3396c}{mModes}.testFlag(\hyperlink{class_q_c_p_painter_a156cf16444ff5e0d81a73c615fdb156daeda679cd55dcd468341d07d48a30b6ab}{pmVectorized})) \textcolor{comment}{// antialiasing half-pixel shift only}
155                                         \textcolor{comment}{// needed for rasterized outputs}
156     \{
157       \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_painter_a7055085da176aee0f6b23298f1003d08}{mIsAntialiasing})
158         translate(0.5, 0.5);
159       \textcolor{keywordflow}{else}
160         translate(-0.5, -0.5);
161     \}
162   \}
163 \}
\end{DoxyCode}
...
\begin{DoxyCode}
205                                                                  \{
206   \textcolor{keywordflow}{if} (!enabled && \hyperlink{class_q_c_p_painter_af5d1d6e5df0adbc7de5633250fb3396c}{mModes}.testFlag(mode))
207     \hyperlink{class_q_c_p_painter_af5d1d6e5df0adbc7de5633250fb3396c}{mModes} &= ~mode;
208   \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (enabled && !\hyperlink{class_q_c_p_painter_af5d1d6e5df0adbc7de5633250fb3396c}{mModes}.testFlag(mode))
209     \hyperlink{class_q_c_p_painter_af5d1d6e5df0adbc7de5633250fb3396c}{mModes} |= mode;
210 \}
\end{DoxyCode}
...
\begin{DoxyCode}
170 \{ \hyperlink{class_q_c_p_painter_af5d1d6e5df0adbc7de5633250fb3396c}{mModes} = \hyperlink{class_q_c_p_painter_a99b89eaf5363faaa1e1e6162856f436c}{modes}; \}
\end{DoxyCode}
...
Definition at line 90 of file qcustomplot.\+cpp.
...
Definition at line 104 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
104                                            \{
105   QPainter::setPen(color);
106   \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_painter_af5d1d6e5df0adbc7de5633250fb3396c}{mModes}.testFlag(\hyperlink{class_q_c_p_painter_a156cf16444ff5e0d81a73c615fdb156dac1e481bfaf408f2bd2eaad3ec341f36b}{pmNonCosmetic}))
107     \hyperlink{class_q_c_p_painter_a7e63fbcf47e35c6f2ecd11b8fef7c7d8}{makeNonCosmetic}();
108 \}
\end{DoxyCode}
