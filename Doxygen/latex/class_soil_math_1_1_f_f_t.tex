...
\begin{DoxyCode}
58                                                     \{
59   \hyperlink{_soil_math_types_8h_a65f85814a8290f9797005d3b28e7e5fc}{uchar} *O = img.data;
60   uint32\_t pEnd = img.cols * img.rows;
61 
62   std::deque<std::deque<uint32\_t>> sCont;
63   std::deque<uint32\_t> eList;
64 
65   \textcolor{comment}{// Initialize the queue}
...
67     \textcolor{keywordflow}{if} (O[\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}] == 1) \{
68       std::deque<uint32\_t> tmpQ;
69       tmpQ.push\_back(\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i});
70       sCont.push\_back(tmpQ);
71       \textcolor{keywordflow}{break};
72     \}
73   \}
74 
75   \textcolor{keywordflow}{if} (sCont.front().size() < 1) \{
76     \textcolor{keywordflow}{throw} Exception::MathException(\textcolor{stringliteral}{"No contour found in image!"});
77   \} \textcolor{comment}{// Exception handling}
78 
79   uint32\_t prev = -1;
80 
81   \textcolor{comment}{// Extend path on queue}
82   \textcolor{keywordflow}{for} (uint32\_t \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} = sCont.front().front(); \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} < pEnd;) \{
83     \hyperlink{_soil_math_types_8h_a1ade796add2f13888dfa9e6bde0bdc37}{iContour\_t} nBors =
84         \hyperlink{class_soil_math_1_1_f_f_t_a45b32ad009154112d2fc4e467fc7c5ac}{Neighbors}(O, \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}, img.cols, img.rows); \textcolor{comment}{// find neighboring pixels}
85     std::deque<uint32\_t> cQ = sCont.front(); \textcolor{comment}{// store first queue;}
86     sCont.erase(sCont.begin()); \textcolor{comment}{// erase first queue from beginning}
87     \textcolor{keywordflow}{if} (cQ.size() > 1) \{
88       prev = cQ.size() - 2;
89     \} \textcolor{keywordflow}{else} \{
90       prev = 0;
91     \}
92     \textcolor{comment}{// Loop through each neighbor}
93     \textcolor{keywordflow}{for} (uint32\_t \hyperlink{_comparision_pictures_2_createtest_image_8m_ac86694252f8dfdb19aaeadc4b7c342c6}{j} = 0; \hyperlink{_comparision_pictures_2_createtest_image_8m_ac86694252f8dfdb19aaeadc4b7c342c6}{j} < nBors.size(); \hyperlink{_comparision_pictures_2_createtest_image_8m_ac86694252f8dfdb19aaeadc4b7c342c6}{j}++) \{
...
128         col = (float)((e % img.cols) - centerCol);
...
Definition at line 161 of file F\+F\+T.\+cpp.
...
\begin{DoxyCode}
161                                  \{
162   CA = CA.apply(std::conj);
163   \hyperlink{class_soil_math_1_1_f_f_t_a48bc7ad948d820d6f87b3e353b6d1cd4}{fft}(CA);
164   CA = CA.apply(std::conj);
165   CA /= CA.size();
166 \}
\end{DoxyCode}
...
Definition at line 54 of file F\+F\+T.\+h.
