...
\item 
Q\+List$<$ \hyperlink{class_q_c_p_item_position}{Q\+C\+P\+Item\+Position} $\ast$ $>$ \hyperlink{class_q_c_p_abstract_item_a96cab718644f27490f9d967c49fcd18c}{m\+Positions}
\item 
Q\+List$<$ \hyperlink{class_q_c_p_item_anchor}{Q\+C\+P\+Item\+Anchor} $\ast$ $>$ \hyperlink{class_q_c_p_abstract_item_a0e1e082dc04ef832411a23905d83cc02}{m\+Anchors}
\item 
...
\begin{DoxyCode}
9196     : \hyperlink{class_q_c_p_layerable_a74c0fa237f29bf0e49565013fc5d1ec0}{QCPLayerable}(parentPlot), \hyperlink{class_q_c_p_abstract_item_ad2a70ff6b658fcb84a9427f69d3f587d}{mClipToAxisRect}(\textcolor{keyword}{false}), 
      \hyperlink{class_q_c_p_abstract_item_ad81eb35c8726a0f458db9df9732e0e41}{mSelectable}(\textcolor{keyword}{true}),
9197       \hyperlink{class_q_c_p_abstract_item_a4bdb3457dad1d268c0f78a44152b9645}{mSelected}(\textcolor{keyword}{false}) \{
9198   QList<QCPAxisRect *> rects = parentPlot->\hyperlink{class_q_custom_plot_afd67094aaeccbc5719761348b2d8c891}{axisRects}();
9199   \textcolor{keywordflow}{if} (rects.size() > 0) \{
9200     \hyperlink{class_q_c_p_abstract_item_a39e05b9d4176b9accafc746d16ca6a06}{setClipToAxisRect}(\textcolor{keyword}{true});
9201     \hyperlink{class_q_c_p_abstract_item_a7dc75fcbcd10206fe0b75d757ea7a347}{setClipAxisRect}(rects.first());
9202   \}
9203 \}
\end{DoxyCode}
...
Definition at line 9205 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
9205                                   \{
9206   \textcolor{comment}{// don't delete mPositions because every position is also an anchor and thus}
9207   \textcolor{comment}{// in mAnchors}
9208   qDeleteAll(\hyperlink{class_q_c_p_abstract_item_a0e1e082dc04ef832411a23905d83cc02}{mAnchors});
9209 \}
\end{DoxyCode}
...
Definition at line 9321 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
9321                                                                 \{
9322   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} = 0; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} < \hyperlink{class_q_c_p_abstract_item_a0e1e082dc04ef832411a23905d83cc02}{mAnchors}.size(); ++\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}) \{
9323     \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_abstract_item_a0e1e082dc04ef832411a23905d83cc02}{mAnchors}.at(\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i})->name() == name)
9324       \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_abstract_item_a0e1e082dc04ef832411a23905d83cc02}{mAnchors}.at(\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i});
9325   \}
9326   qDebug() << Q\_FUNC\_INFO << \textcolor{stringliteral}{"anchor with name not found:"} << name;
9327   \textcolor{keywordflow}{return} 0;
9328 \}
\end{DoxyCode}
...
\begin{DoxyCode}
9478                                                             \{
9479   qDebug() << Q\_FUNC\_INFO << \textcolor{stringliteral}{"called on item which shouldn't have any anchors "}
9480                              \textcolor{stringliteral}{"(this method not reimplemented). anchorId"}
9481            << anchorId;
9482   \textcolor{keywordflow}{return} QPointF();
9483 \}
\end{DoxyCode}
...
\begin{DoxyCode}
1876 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_abstract_item_a0e1e082dc04ef832411a23905d83cc02}{mAnchors}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
9382                                                                             \{
9383   \hyperlink{class_q_c_p_layerable_a62bd552d1a45aa9accb24b310542279e}{applyAntialiasingHint}(painter, \hyperlink{class_q_c_p_layerable_a3ab45a4c76a3333ce42eb217a81733ec}{mAntialiased}, 
...
Definition at line 9213 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
9213                                                  \{
9214   \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_abstract_item_a3e57cfe7da4b1ac3d6fa7281ea437361}{mClipAxisRect}.data();
9215 \}
\end{DoxyCode}
...
\begin{DoxyCode}
1859 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_abstract_item_ad2a70ff6b658fcb84a9427f69d3f587d}{mClipToAxisRect}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
9549                                                            \{
9550   \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_abstract_item_acbce9e5ba5252541d19db0c40303357a}{hasAnchor}(name))
9551     qDebug() << Q\_FUNC\_INFO
9552              << \textcolor{stringliteral}{"anchor/position with name exists already:"} << name;
9553   \hyperlink{class_q_c_p_item_anchor}{QCPItemAnchor} *newAnchor =
9554       \textcolor{keyword}{new} \hyperlink{class_q_c_p_abstract_item_a61767d414fd57af9eb1741b34268c7fc}{QCPItemAnchor}(\hyperlink{class_q_c_p_layerable_aa2a528433e44db02b8aef23c1f9f90ed}{mParentPlot}, \textcolor{keyword}{this}, name, anchorId);
9555   \hyperlink{class_q_c_p_abstract_item_a0e1e082dc04ef832411a23905d83cc02}{mAnchors}.append(newAnchor);
9556   \textcolor{keywordflow}{return} newAnchor;
9557 \}
\end{DoxyCode}
...
Definition at line 9505 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
9574                                                                \{
9575   \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_abstract_item_ad81eb35c8726a0f458db9df9732e0e41}{mSelectable}) \{
9576     \textcolor{keywordtype}{bool} selBefore = \hyperlink{class_q_c_p_abstract_item_a4bdb3457dad1d268c0f78a44152b9645}{mSelected};
9577     \hyperlink{class_q_c_p_abstract_item_a203de94ad586cc44d16c9565f49d3378}{setSelected}(\textcolor{keyword}{false});
9578     \textcolor{keywordflow}{if} (selectionStateChanged)
9579       *selectionStateChanged = \hyperlink{class_q_c_p_abstract_item_a4bdb3457dad1d268c0f78a44152b9645}{mSelected} != selBefore;
9580   \}
9581 \}
\end{DoxyCode}
...
\begin{DoxyCode}
9401                                                                   \{
9402   QVector2D a(start);
9403   QVector2D b(end);
9404   QVector2D p(point);
9405   QVector2D v(b - a);
9406 
9407   \textcolor{keywordtype}{double} vLengthSqr = v.lengthSquared();
9408   \textcolor{keywordflow}{if} (!qFuzzyIsNull(vLengthSqr)) \{
9409     \textcolor{keywordtype}{double} mu = QVector2D::dotProduct(p - a, v) / vLengthSqr;
9410     \textcolor{keywordflow}{if} (mu < 0)
9411       \textcolor{keywordflow}{return} (a - p).lengthSquared();
9412     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (mu > 1)
9413       \textcolor{keywordflow}{return} (b - p).lengthSquared();
9414     \textcolor{keywordflow}{else}
9415       \textcolor{keywordflow}{return} ((a + mu * v) - p).lengthSquared();
9416   \} \textcolor{keywordflow}{else}
9417     \textcolor{keywordflow}{return} (a - p).lengthSquared();
9418 \}
\end{DoxyCode}
...
\begin{DoxyCode}
9339                                                          \{
9340   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} = 0; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} < \hyperlink{class_q_c_p_abstract_item_a0e1e082dc04ef832411a23905d83cc02}{mAnchors}.size(); ++\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}) \{
9341     \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_abstract_item_a0e1e082dc04ef832411a23905d83cc02}{mAnchors}.at(\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i})->name() == name)
9342       \textcolor{keywordflow}{return} \textcolor{keyword}{true};
9343   \}
9344   \textcolor{keywordflow}{return} \textcolor{keyword}{false};
9345 \}
\end{DoxyCode}
...
Definition at line 9299 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
9299                                                                     \{
9300   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} = 0; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} < \hyperlink{class_q_c_p_abstract_item_a96cab718644f27490f9d967c49fcd18c}{mPositions}.size(); ++\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}) \{
9301     \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_abstract_item_a96cab718644f27490f9d967c49fcd18c}{mPositions}.at(\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i})->name() == name)
9302       \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_abstract_item_a96cab718644f27490f9d967c49fcd18c}{mPositions}.at(\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i});
9303   \}
9304   qDebug() << Q\_FUNC\_INFO << \textcolor{stringliteral}{"position with name not found:"} << name;
9305   \textcolor{keywordflow}{return} 0;
9306 \}
\end{DoxyCode}
...
\begin{DoxyCode}
1875 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_abstract_item_a96cab718644f27490f9d967c49fcd18c}{mPositions}; \}
\end{DoxyCode}
...
Definition at line 9440 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
9441                                                               \{
9442   \textcolor{keywordtype}{double} result = -1;
9443 
9444   \textcolor{comment}{// distance to border:}
9445   QList<QLineF> lines;
9446   lines << QLineF(\hyperlink{_gen_blob_8m_aea8f6815d9a63491fc422c5572c6b3c3}{rect}.topLeft(), \hyperlink{_gen_blob_8m_aea8f6815d9a63491fc422c5572c6b3c3}{rect}.topRight())
9447         << QLineF(\hyperlink{_gen_blob_8m_aea8f6815d9a63491fc422c5572c6b3c3}{rect}.bottomLeft(), \hyperlink{_gen_blob_8m_aea8f6815d9a63491fc422c5572c6b3c3}{rect}.bottomRight())
9448         << QLineF(\hyperlink{_gen_blob_8m_aea8f6815d9a63491fc422c5572c6b3c3}{rect}.topLeft(), \hyperlink{_gen_blob_8m_aea8f6815d9a63491fc422c5572c6b3c3}{rect}.bottomLeft())
9449         << QLineF(\hyperlink{_gen_blob_8m_aea8f6815d9a63491fc422c5572c6b3c3}{rect}.topRight(), \hyperlink{_gen_blob_8m_aea8f6815d9a63491fc422c5572c6b3c3}{rect}.bottomRight());
9450   \textcolor{keywordtype}{double} minDistSqr = std::numeric\_limits<double>::max();
9451   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} = 0; \hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i} < lines.size(); ++\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}) \{
9452     \textcolor{keywordtype}{double} distSqr = \hyperlink{class_q_c_p_abstract_item_acdca343717d625b8abb3c3e38c0ed39d}{distSqrToLine}(lines.at(\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}).p1(), lines.at(\hyperlink{_comparision_pictures_2_createtest_image_8m_a6f6ccfcf58b31cb6412107d9d5281426}{i}).p2(), pos);
9453     \textcolor{keywordflow}{if} (distSqr < minDistSqr)
9454       minDistSqr = distSqr;
9455   \}
9456   result = qSqrt(minDistSqr);
9457 
9458   \textcolor{comment}{// filled rect, allow click inside to count as hit:}
9459   \textcolor{keywordflow}{if} (filledRect && result > \hyperlink{class_q_c_p_layerable_aa2a528433e44db02b8aef23c1f9f90ed}{mParentPlot}->\hyperlink{class_q_custom_plot_a7b738074c75e80070ef6a10263c6cd69}{selectionTolerance}() * 0.99) \{
9460     \textcolor{keywordflow}{if} (\hyperlink{_gen_blob_8m_aea8f6815d9a63491fc422c5572c6b3c3}{rect}.contains(pos))
9461       result = \hyperlink{class_q_c_p_layerable_aa2a528433e44db02b8aef23c1f9f90ed}{mParentPlot}->\hyperlink{class_q_custom_plot_a7b738074c75e80070ef6a10263c6cd69}{selectionTolerance}() * 0.99;
9462   \}
...
\begin{DoxyCode}
1861 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_abstract_item_ad81eb35c8726a0f458db9df9732e0e41}{mSelectable}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
1862 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_abstract_item_a4bdb3457dad1d268c0f78a44152b9645}{mSelected}; \}
\end{DoxyCode}
...
Definition at line 9560 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
9562                                                                \{
9563   Q\_UNUSED(event)
9564   Q\_UNUSED(details)
9565   if (\hyperlink{class_q_c_p_abstract_item_ad81eb35c8726a0f458db9df9732e0e41}{mSelectable}) \{
9566     \textcolor{keywordtype}{bool} selBefore = \hyperlink{class_q_c_p_abstract_item_a4bdb3457dad1d268c0f78a44152b9645}{mSelected};
9567     \hyperlink{class_q_c_p_abstract_item_a203de94ad586cc44d16c9565f49d3378}{setSelected}(additive ? !\hyperlink{class_q_c_p_abstract_item_a4bdb3457dad1d268c0f78a44152b9645}{mSelected} : \textcolor{keyword}{true});
9568     \textcolor{keywordflow}{if} (selectionStateChanged)
9569       *selectionStateChanged = \hyperlink{class_q_c_p_abstract_item_a4bdb3457dad1d268c0f78a44152b9645}{mSelected} != selBefore;
9570   \}
9571 \}
\end{DoxyCode}
...
\begin{DoxyCode}
9584                                                         \{
9585   \textcolor{keywordflow}{return} \hyperlink{namespace_q_c_p_a2ad6bb6281c7c2d593d4277b44c2b037aea2f7c105d674e76d9b187b02ef29260}{QCP::iSelectItems};
9586 \}
\end{DoxyCode}
...
Definition at line 9237 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
9224                                                  \{
9225   \hyperlink{class_q_c_p_abstract_item_ad2a70ff6b658fcb84a9427f69d3f587d}{mClipToAxisRect} = clip;
9226   \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_abstract_item_ad2a70ff6b658fcb84a9427f69d3f587d}{mClipToAxisRect})
9227     \hyperlink{class_q_c_p_layerable_aa23c893671f1f6744ac235cf2204cf3a}{setParentLayerable}(\hyperlink{class_q_c_p_abstract_item_a3e57cfe7da4b1ac3d6fa7281ea437361}{mClipAxisRect}.data());
9228 \}
\end{DoxyCode}
...
Definition at line 9254 of file qcustomplot.\+cpp.
...
\begin{DoxyCode}
9254                                                    \{
9255   \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_abstract_item_ad81eb35c8726a0f458db9df9732e0e41}{mSelectable} != \hyperlink{class_q_c_p_abstract_item_a9189e752025533e1595eaade0009a3bc}{selectable}) \{
9256     \hyperlink{class_q_c_p_abstract_item_ad81eb35c8726a0f458db9df9732e0e41}{mSelectable} = \hyperlink{class_q_c_p_abstract_item_a9189e752025533e1595eaade0009a3bc}{selectable};
9257     emit \hyperlink{class_q_c_p_abstract_item_a5b266c11aac61cb511901f3911dac2a3}{selectableChanged}(\hyperlink{class_q_c_p_abstract_item_ad81eb35c8726a0f458db9df9732e0e41}{mSelectable});
9258   \}
9259 \}
\end{DoxyCode}
...
\hypertarget{class_q_c_p_abstract_item_a0e1e082dc04ef832411a23905d83cc02}{}\index{Q\+C\+P\+Abstract\+Item@{Q\+C\+P\+Abstract\+Item}!m\+Anchors@{m\+Anchors}}
...
\hypertarget{class_q_c_p_abstract_item_a96cab718644f27490f9d967c49fcd18c}{}\index{Q\+C\+P\+Abstract\+Item@{Q\+C\+P\+Abstract\+Item}!m\+Positions@{m\+Positions}}
