...
741   \hyperlink{class_q_c_p_layer_a2f3374a7884bf403720cd1cf6f7ad1bb}{mParentPlot}(parentPlot),
742   \hyperlink{class_q_c_p_layer_a91e6298183cb4b9dfd4efdfaf1ecc220}{mName}(layerName),
743   \hyperlink{class_q_c_p_layer_a122088bcab6cec76a52b75ce8606605b}{mIndex}(-1), \textcolor{comment}{// will be set to a proper value by the QCustomPlot layer creation function}
744   \hyperlink{class_q_c_p_layer_a264950deb08e589460c126c895a1e2b5}{mVisible}(\textcolor{keyword}{true})
745 \{
746   \textcolor{comment}{// Note: no need to make sure layerName is unique, because layer}
747   \textcolor{comment}{// management is done with QCustomPlot functions.}
748 \}
\end{DoxyCode}
...
\begin{DoxyCode}
751 \{
752   \textcolor{comment}{// If child layerables are still on this layer, detach them, so they don't try to reach back to this}
753   \textcolor{comment}{// then invalid layer once they get deleted/moved themselves. This only happens when layers are deleted}
754   \textcolor{comment}{// directly, like in the QCustomPlot destructor. (The regular layer removal procedure for the user is to}
755   \textcolor{comment}{// call QCustomPlot::removeLayer, which moves all layerables off this layer before deleting it.)}
756   
757   \textcolor{keywordflow}{while} (!\hyperlink{class_q_c_p_layer_a704aa71bba469383c3a3c598c1ec0d28}{mChildren}.isEmpty())
758     \hyperlink{class_q_c_p_layer_a704aa71bba469383c3a3c598c1ec0d28}{mChildren}.last()->setLayer(0); \textcolor{comment}{// removes itself from mChildren via removeChild()}
759   
760   \textcolor{keywordflow}{if} (\hyperlink{class_q_c_p_layer_a2f3374a7884bf403720cd1cf6f7ad1bb}{mParentPlot}->\hyperlink{class_q_custom_plot_af73057345656cbd1463454982d808b00}{currentLayer}() == \textcolor{keyword}{this})
761     qDebug() << Q\_FUNC\_INFO << \textcolor{stringliteral}{"The parent plot's mCurrentLayer will be a dangling pointer. Should have
       been set to a valid layer or 0 beforehand."};
762 \}
\end{DoxyCode}
...
\begin{DoxyCode}
788 \{
789   \textcolor{keywordflow}{if} (!\hyperlink{class_q_c_p_layer_a704aa71bba469383c3a3c598c1ec0d28}{mChildren}.contains(layerable))
790   \{
791     \textcolor{keywordflow}{if} (prepend)
792       \hyperlink{class_q_c_p_layer_a704aa71bba469383c3a3c598c1ec0d28}{mChildren}.prepend(layerable);
793     \textcolor{keywordflow}{else}
794       \hyperlink{class_q_c_p_layer_a704aa71bba469383c3a3c598c1ec0d28}{mChildren}.append(layerable);
795   \} \textcolor{keywordflow}{else}
796     qDebug() << Q\_FUNC\_INFO << \textcolor{stringliteral}{"layerable is already child of this layer"} << \textcolor{keyword}{reinterpret\_cast<}quintptr\textcolor{keyword}{>}(
      layerable);
797 \}
\end{DoxyCode}
...
\begin{DoxyCode}
383 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_layer_a704aa71bba469383c3a3c598c1ec0d28}{mChildren}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
382 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_layer_a122088bcab6cec76a52b75ce8606605b}{mIndex}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
381 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_layer_a91e6298183cb4b9dfd4efdfaf1ecc220}{mName}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
380 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_layer_a2f3374a7884bf403720cd1cf6f7ad1bb}{mParentPlot}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
809 \{
810   \textcolor{keywordflow}{if} (!\hyperlink{class_q_c_p_layer_a704aa71bba469383c3a3c598c1ec0d28}{mChildren}.removeOne(layerable))
811     qDebug() << Q\_FUNC\_INFO << \textcolor{stringliteral}{"layerable is not child of this layer"} << \textcolor{keyword}{reinterpret\_cast<}quintptr\textcolor{keyword}{>}(
      layerable);
812 \}
\end{DoxyCode}
...
\begin{DoxyCode}
773 \{
774   \hyperlink{class_q_c_p_layer_a264950deb08e589460c126c895a1e2b5}{mVisible} = \hyperlink{class_q_c_p_layer_a9efca636e4dcad721999a6282f296016}{visible};
775 \}
\end{DoxyCode}
...
\begin{DoxyCode}
384 \{ \textcolor{keywordflow}{return} \hyperlink{class_q_c_p_layer_a264950deb08e589460c126c895a1e2b5}{mVisible}; \}
\end{DoxyCode}
