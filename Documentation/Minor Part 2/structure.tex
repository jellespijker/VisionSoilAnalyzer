...
\usetikzlibrary{arrows,arrows.meta,decorations.pathmorphing,backgrounds,positioning,fit,petri,shapes,calc}
...
%IPO graphs
\tikzstyle{block} = [rectangle,rounded corners, minimum width=3cm,text centered, draw=ocre!50, fill=ocre!30]
