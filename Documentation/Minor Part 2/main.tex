...
\subsection{CIE La*b* extraction}

\subsection{Fast Fourier Descriptors}

\subsection{SI equivalent diameter}


\section{Classification}\index{Classification}

\subsection{Roundness using Hu-moments}\index{Roundness} \index{Hu-moments}

\subsection{Angularity using a Neural Network}\index{Angularity} \index{Neural Network}
...
\includepdf{../Minor Part 1/Literatuurstudie - Grond en Computer Vision.pdf}
